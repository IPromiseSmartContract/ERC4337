...
contract PermitPaymaster is Paymaster {
    ...
    mapping(ERC20Permit => IOracle) public oracles;
    mapping(ERC20Permit => mapping(address => uint256)) public balances;
     ...
     */
    function addToken(ERC20Permit token, IOracle tokenPriceOracle) external onlyOwner {
     ...
     */
    function withdrawTokensTo(ERC20Permit token, address target, uint256 amount) public {
        require(
    ...
    function _validatePaymasterUserOp(
        ...
        ERC20Permit token = ERC20Permit(address(bytes20(paymasterAndData[20:])));
